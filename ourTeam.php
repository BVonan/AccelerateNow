  ...
  <div class="container">
    ...
    <section class="team-section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2>Meet Our Founder & Team of One</h2>
                    <div class="team-member">
                        <div class="member-details">
                            <h3>Founder / Creator / UX/UI Designer / Programmer</h3>
                            <p>As the sole member of our team, I handle all aspects of our business, from conceptualization to development. Here are some of my responsibilities:</p>
                            <ul>
                            ...
                            <p>I am passionate about delivering high-quality products and services to our users and continuously improving our offerings.</p>
