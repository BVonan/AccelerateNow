...
<body class="bg-gray-100">
    <div class="container mx-auto py-8">
        ...
        <p class="mb-4">Please note: This contact page is for demonstration purposes only and does not represent a real business. The location displayed is a reference to the college attended.</p>
        ...
        <form action="/submit_contact_form.php" method="post" class="max-w-lg">
            ...
            <div class="mb-4">
                ...
                <textarea id="message" name="message" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></textarea>
            </div>
            <div class="mb-4">
